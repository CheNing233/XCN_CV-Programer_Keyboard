...
// 厂家信息
const uint8_t USB_ManuInfo_StrDescr[] = { 0x14, 0x03, 'x', 0, 'C', 0, 'h', 0, 'e', 0, 'n', 0, 'N', 0, 'I', 0, 'n', 0,
    'g', 0 };

// 产品信息
const uint8_t USB_ProdInfo_StrDescr[] = { 0x2A, 0x03, 'X', 0, 'C', 0, 'N', 0, ' ', 0, 'K', 0, 'e', 0, 'y', 0, 'b', 0,
    'o', 0, 'a', 0, 'r', 0, 'd', 0, ' ', 0, 'V', 0, '5', 0, '7', 0, '3', 0, 'U', 0, 'S', 0, 'B', 0 };
