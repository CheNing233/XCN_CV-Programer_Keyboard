...
struct _SSD13xx_Class {
     ...
     */
    void (*Init)(SSD13xx_InitTypeDef *SSD13xx_InitStructure,
     ...
     * @parameter ... 可变参数列表
     */
    void (*PrintF)(SSD13xx_handle_t SSD13xx_Handle, uint8_t pos_x,
            uint8_t pos_y, const char* ptr_format, ...);

    void (*Print)(SSD13xx_handle_t SSD13xx_Handle, uint8_t pos_x, uint8_t pos_y,
     ...
     * @parameter ch 要打印的字符
     */
    void (*PutChar)(SSD13xx_handle_t SSD13xx_Handle, uint8_t pos_x,
     ...
     * @parameter Pos_Y Y轴坐标
     */
    void (*SetCursor)(SSD13xx_handle_t SSD13xx_Handle, uint8_t Pos_X,
            uint8_t Pos_Y);
};
